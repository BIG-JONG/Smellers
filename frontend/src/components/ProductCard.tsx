  ...
  return (
    ...
    >
      ...
      <div className="p-3">
        ...
        <h5 className="mt-4 text-md font-medium text-gray-800 sm:text-md">₩ {product.price.toLocaleString()}</h5> {/* ✨ product.price 사용 및 포맷팅 */}
        ...
        <div className="flex items-center">
          <StarRating rating={product.rating} maxRating={5} className="w-2 h-2"/> {/* product.rating 사용 */}
