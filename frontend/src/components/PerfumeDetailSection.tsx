...
const PerfumeDetailSection: React.FC<PerfumeDetailSectionProps> = ({ perfume }) => {
  ...
  const categoryColors = {
    top: { bg: 'rgba(255, 99, 132, 0.8)', border: 'rgba(255, 99, 132, 1)' }, // Red-ish
    middle: { bg: 'rgba(54, 162, 235, 0.8)', border: 'rgba(54, 162, 235, 1)' }, // Blue-ish
    base: { bg: 'rgba(75, 192, 192, 0.8)', border: 'rgba(75, 192, 192, 1)' }, // Green-ish
  };
  ...
  return (
    <div className="flex flex-col items-center w-full">
      {/* 향수 상세 정보 상단 섹션 */}
      <div className="flex flex-col md:flex-row items-start gap-12 md:gap-24 p-6 md:p-12 max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
        {/* 왼쪽 이미지 영역 */}
        ...
        <div className="flex flex-col gap-2 w-full md:w-2/3">
          ...
          {/* 브랜드 */}
          <p className="mt-2 text-xl font-semibold text-gray-600 dark:text-gray-300">{perfume.brand}</p>
      ...
      <div className="w-full max-w-4xl bg-white p-8 rounded-lg shadow-lg mt-8 flex flex-col items-center">
        <h3 className="text-2xl font-semibold text-gray-800 mb-6">향료별 존재감 분석</h3>
